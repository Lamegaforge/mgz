...
<section class="relative border-t border-gray-900">
    <div class="px-4 py-6 mx-auto -mt-16 max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col items-center sm:flex-row">
            ...
            <div class="sm:ml-6 sm:mt-8">
                <p class="text-3xl">{{$user->display_name}}</p>
                <div class="flex justify-center mt-2 space-x-3">
                    <a href="https://www.facebook.com/LaMegaforge/" class="text-gray-400 hover:text-gray-500">
                        <span class="sr-only">Facebook</span><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                        </svg></a><a href="https://www.instagram.com/lamegaforge/" class="text-gray-400 hover:text-gray-500"><span class="sr-only">Instagram</span><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        </svg></a><a href="https://twitter.com/LaMegaforge" class="text-gray-400 hover:text-gray-500"><span class="sr-only">Twitter</span><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
